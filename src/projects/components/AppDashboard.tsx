  ...
  return (
    <>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-4'>
        <div className='bg-primary-foreground p-4 rounded-lg shadow-sm sm:col-span-2 lg:col-span-3 xl:col-span-2'>
          <AppBarChart></AppBarChart>
        </div>
        <div className='bg-primary-foreground p-4 rounded-lg shadow-sm sm:col-span-2'>
          <AppAreaChart></AppAreaChart>
        </div>
        <div className='bg-primary-foreground p-4 rounded-lg shadow-sm sm:col-span-2 md:col-span-1'>
